...
using MyName.Infra.Repository.Mongo.Interfaces;
using Microsoft.Extensions.DependencyInjection;

namespace MyName.Infra.Repository.Mongo.Extensions
{
    /// <summary>
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// </remarks>
        public static MongoConfigurationBuilder AddMyNameInfraMongo<TContext>(this IServiceCollection services, Action<MongoRepositoryOptions> configurator)
            where TContext : IMongoContext
        {
            if (services.HasRegistered(nameof(AddMyNameInfraMongo)))
                return default;
        ...
        /// This currently requires wiring up memory caching and logging.
        /// </remarks>
        public static MongoConfigurationBuilder AddMyNameInfraMongo<TContext>(this IServiceCollection services, string connectionString)
             where TContext : IMongoContext
        {
            return services.AddMyNameInfraMongo<TContext>(c => c.ConnectionString = connectionString);
        }
    }
}