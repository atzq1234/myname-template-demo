...
public static class ServiceCollectionExtension
{
    ...
    //public static IServiceCollection AddMyNameInfraHangfireWithServer(this IServiceCollection services,IConfigurationSection hangfireSection, Assembly assembly)
    //{
    //    if (services.HasRegistered(nameof(AddMyNameInfraHangfireWithServer)) || hangfireSection is null)
    //        return services;
    ...
    //    return AddMyNameInfraHangfireServer(services, hangfireSection);
    //}
    ...
    /// </summary>
    /// <param name="builder"></param>
    //public static IServiceCollection AddMyNameInfraHangfireServer(this IServiceCollection services, IConfigurationSection hangfireSection)
    //{
    //    if (services.HasRegistered(nameof(AddMyNameInfraHangfireServer)) || hangfireSection is null)
    //        return services;
