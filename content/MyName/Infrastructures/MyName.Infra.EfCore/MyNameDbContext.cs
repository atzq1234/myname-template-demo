namespace MyName.Infra.Repository.EfCore;

public abstract class MyNameDbContext : DbContext
{
    private readonly IEntityInfo _entityInfo;

    protected MyNameDbContext(DbContextOptions options,IEntityInfo entityInfo)
        : base(options)
    {
