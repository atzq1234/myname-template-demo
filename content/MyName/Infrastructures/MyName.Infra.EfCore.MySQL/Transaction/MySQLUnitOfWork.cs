namespace MyName.Infra.Repository.EfCore.MySql.Transaction;
        ...
        , bool distributed = false)
    {
        if (distributed)
            if (_publisher is null)
                ...
                return MyNameDbContext.Database.BeginTransaction(_publisher, false);
        else
            return MyNameDbContext.Database.BeginTransaction(isolationLevel);
    }
}