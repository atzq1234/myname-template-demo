using MyName.Infra.Core.Json;
using MyName.Infra.Redis.Core.Internal;

namespace MyName.Infra.Redis.Core.Serialization
{
    /// <summary>
    ...
    public class DefaultJsonSerializer : ISerializer
    {
        ...
        /// The json serializer.
        /// </summary>
        private static readonly JsonSerializerOptions jsonSerializerOption = SystemTextJson.GetMyNameDefaultOptions();
