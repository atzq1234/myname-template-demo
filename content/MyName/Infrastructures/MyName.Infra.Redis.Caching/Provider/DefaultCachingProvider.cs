...
using MyName.Infra.Redis.Caching.Core;
using MyName.Infra.Redis.Configurations;
using MyName.Infra.Redis.Core;
using MyName.Infra.Redis.Core.Serialization;
using MyName.Infra.Redis.Providers.StackExchange;

namespace MyName.Infra.Redis.Caching.Provider;
...
public partial class DefaultCachingProvider : AbstracCacheProvider, ICacheProvider
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:MyName.Infra.Redis.Redis.DefaultRedisCachingProvider"/> class.
    /// </summary>
    ...
    private RedisKey[] SearchRedisKeys(string pattern)
    {
        ...
        foreach (var server in _servers)
            ...
            // see https://github.com/dotnetcore/MyName.Infra.Redis/pull/199 for more information
