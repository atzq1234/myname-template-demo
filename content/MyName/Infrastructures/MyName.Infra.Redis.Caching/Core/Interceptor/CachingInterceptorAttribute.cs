namespace MyName.Infra.Redis.Caching.Core.Interceptor
{
    using System;

    /// <summary>
    /// MyName.Infra.Redis interceptor attribute.
    /// </summary>
    ...
    public class CachingInterceptorAttribute : Attribute
    {
        ...
        /// <summary>
        /// Gets or sets the cache provider name. The default value is MyName.Infra.RedisInterceptorOptions.CacheProviderName"/>
        /// </summary>
        /// <value>The cache key prefix.</value>
