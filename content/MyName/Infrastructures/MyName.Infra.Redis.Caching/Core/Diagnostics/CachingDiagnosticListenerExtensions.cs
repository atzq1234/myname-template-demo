namespace MyName.Infra.Redis.Caching.Core.Diagnostics
{
    /// <summary>
    /// Extension methods on the DiagnosticListener class to log MyName.Infra.Redis
    /// </summary>
    public static class CachingDiagnosticListenerExtensions
    {
        ...
        private const string CachingPrefix = nameof(MyName.Infra.Redis.Caching);
