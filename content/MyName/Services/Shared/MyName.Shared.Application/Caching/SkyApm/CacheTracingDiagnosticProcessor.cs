namespace MyName.Shared.Application.Caching.SkyApm;

public sealed class CacheTracingDiagnosticProcessor : ITracingDiagnosticProcessor
{
    public static readonly StringOrIntValue Caching = new (nameof(MyName.Infra.Redis.Caching));
    ...
    public void CachingBeforeGetCache([Object] DiagnosticDataWrapper<BeforeGetRequestEventData> eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message("MyName.Caching get cache start..."));
    }
    ...
    public void CachingAfterGetCache([Object] DiagnosticDataWrapper eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message($"MyName.Caching get cache succeeded!{Environment.NewLine}" +
    ...
    public void CachingErrorGetCache([Object] DiagnosticExceptionWrapper eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message($"MyName.Caching get cache failed!{Environment.NewLine}" +
                                             $"--> Message Id: { eventData.OperationId }"));
    ...
    public void CachingBeforeSetCache([Object] DiagnosticDataWrapper<BeforeSetRequestEventData> eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message("MyName.Caching Set cache start..."));
    }
    ...
    public void CachingAfterSetCache([Object] DiagnosticDataWrapper eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message($"MyName.Caching set cache succeeded!{Environment.NewLine}" +
                                             $"--> Message Id: { eventData.OperationId }"));
    ...
    public void CachingErrorSetCache([Object] DiagnosticExceptionWrapper eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message($"MyName.Caching set cache failed!{Environment.NewLine}" +
                                             $"--> Message Id: { eventData.OperationId }"));
        context.Span.ErrorOccurred(eventData.Exception, _tracingConfig);
    ...
    public void CachingBeforeRemoveCache([Object] DiagnosticDataWrapper<BeforeRemoveRequestEventData> eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message("MyName.Caching Remove cache start..."));
    }
    ...
    public void CachingAfterRemoveCache([Object] DiagnosticDataWrapper eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message($"MyName.Caching remove cache succeeded!{Environment.NewLine}" +
                                             $"--> Message Id: { eventData.OperationId }"));
    ...
    public void CachingErrorRemoveCache([Object] DiagnosticExceptionWrapper eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message($"MyName.Caching remove cache failed!{Environment.NewLine}" +
                                             $"--> Message Id: { eventData.OperationId }"));
        context.Span.ErrorOccurred(eventData.Exception, _tracingConfig);
    ...
    public void CachingBeforeExistsCache([Object] DiagnosticDataWrapper<BeforeExistsRequestEventData> eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message("MyName.Caching exists cache start..."));
    }
    ...
    public void CachingAfterExistsCache([Object] DiagnosticDataWrapper eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message($"MyName.Caching exists cache succeeded!{Environment.NewLine}" +
                                             $"--> Message Id: { eventData.OperationId }"));
    ...
    public void CachingErrorExistsCache([Object] DiagnosticExceptionWrapper eventData)
    {
        ...
        context.Span.AddLog(LogEvent.Message($"MyName.Caching exists cache failed!{Environment.NewLine}" +
                                             $"--> Message Id: { eventData.OperationId }"));
        context.Span.ErrorOccurred(eventData.Exception, _tracingConfig);
