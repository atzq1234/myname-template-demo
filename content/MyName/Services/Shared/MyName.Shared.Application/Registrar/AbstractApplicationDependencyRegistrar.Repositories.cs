using MyName.Infra.Repository.EfCore.MySql.Configurations;
using MyName.Infra.Repository.Mongo;
using MyName.Infra.Repository.Mongo.Configuration;
using MyName.Infra.Repository.Mongo.Extensions;
using Microsoft.EntityFrameworkCore;

namespace MyName.Shared.Application.Registrar;
...
public abstract partial class AbstractApplicationDependencyRegistrar
{
    ...
    protected virtual void AddEfCoreContext()
    {
        ...
        Services.AddMyNameInfraEfCoreMySql(options =>
        {
            ...
            //options.ReplaceService<IQuerySqlGeneratorFactory, MyNameMySqlQuerySqlGeneratorFactory>();
        });
    }
    ...
    protected virtual void AddMongoContextWithRepositries(Action<IServiceCollection> action = null)
    {
        ...
        Services.AddMyNameInfraMongo<MongoContext>(options =>
        {
