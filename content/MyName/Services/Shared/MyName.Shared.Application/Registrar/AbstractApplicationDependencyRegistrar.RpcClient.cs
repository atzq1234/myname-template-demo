using MyName.Infra.Consul.Discover.GrpcResolver;
using MyName.Infra.Consul.Discover.Handler;
using MyName.Shared.Consts.AppSettings;
using MyName.Shared.Consts.RegistrationCenter;
using MyName.Shared.Rpc.Handlers;
...
public abstract partial class AbstractApplicationDependencyRegistrar
{
     ...
     where TRestClient : class
    {
        ...
        var contentSerializer = new SystemTextJsonContentSerializer(SystemTextJson.GetMyNameDefaultOptions());
