...
public static class WebApplicationBuilderExtension
{
    ...
    public static WebApplicationBuilder ConfigureMyNameDefault(this WebApplicationBuilder builder, IServiceInfo serviceInfo)
    {
        if (builder is null)
        ...
        builder.Services.AddMyName(serviceInfo);
