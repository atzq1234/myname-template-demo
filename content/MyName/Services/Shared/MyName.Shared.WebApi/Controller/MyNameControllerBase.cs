...
public abstract class MyNameControllerBase : ControllerBase
{
    /// <summary>
    /// MyName.Shared.Application.Services.ProblemDetails.ProblemDetails => Problem
    /// </summary>
    /// <param name="problemDetails"><see cref="MyName.Shared.Application.Services.ProblemDetails"/></param>
    /// <returns><see cref="ObjectResult"/></returns>
    [NonAction]
    protected virtual ObjectResult Problem(MyName.Shared.Application.Contracts.ResultModels.ProblemDetails problemDetails)
    {
