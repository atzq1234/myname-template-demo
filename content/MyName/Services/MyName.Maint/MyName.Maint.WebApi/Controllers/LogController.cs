...
/// </summary>
[Route("maint")]
public class LogController : MyNameControllerBase
{
    ...
    /// <returns></returns>
    [HttpGet("opslogs")]
    [MyNameAuthorize(PermissionConsts.Log.GetListForOperationLog)]
    ...
    /// <returns></returns>
    [HttpGet("loginlogs")]
    [MyNameAuthorize(PermissionConsts.Log.GetListForLogingLog)]
    ...
    /// <returns></returns>
    [HttpGet("nloglogs")]
    [MyNameAuthorize(PermissionConsts.Log.GetListForNLog)]
