...
[Route("maint/cfgs")]
[ApiController]
public class CfgController : MyNameControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [MyNameAuthorize(PermissionConsts.Cfg.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [MyNameAuthorize(PermissionConsts.Cfg.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [MyNameAuthorize(PermissionConsts.Cfg.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet("{id}")]
    [MyNameAuthorize(PermissionConsts.Cfg.GetList, MyNameAuthorizeAttribute.JwtWithBasicSchemes)]
    ...
    [HttpGet()]
    [MyNameAuthorize(PermissionConsts.Cfg.GetList)]
    [ProducesResponseType(StatusCodes.Status200OK)]
