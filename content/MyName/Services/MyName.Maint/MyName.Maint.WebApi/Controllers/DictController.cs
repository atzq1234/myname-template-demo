namespace MyName.Maint.WebApi.Controllers;
...
[Route("maint/dicts")]
[ApiController]
public class DictController : MyNameControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [MyNameAuthorize(PermissionConsts.Dict.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [MyNameAuthorize(PermissionConsts.Dict.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [MyNameAuthorize(PermissionConsts.Dict.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet()]
    [MyNameAuthorize(PermissionConsts.Dict.GetList)]
    ...
    /// <returns></returns>
    [HttpGet("{id}")]
    [MyNameAuthorize(PermissionConsts.Dict.GetList, MyNameAuthorizeAttribute.JwtWithBasicSchemes)]
    [ProducesResponseType(StatusCodes.Status200OK)]
