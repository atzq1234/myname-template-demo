...
using MyName.Shared.Rpc.Grpc.Messages;
using Google.Protobuf.WellKnownTypes;
using Grpc.Core;

namespace MyName.Maint.WebApi.Grpc;

public class MaintGrpcServer : MyName.Shared.Rpc.Grpc.Services.MaintGrpc.MaintGrpcBase
{
