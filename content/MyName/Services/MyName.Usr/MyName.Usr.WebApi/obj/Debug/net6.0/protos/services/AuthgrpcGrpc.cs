...
namespace MyName.Shared.Rpc.Grpc.Services {
  public static partial class AuthGrpc
  {
    ...
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::MyName.Shared.Rpc.Grpc.Messages.GrpcResponse> Login(global::MyName.Shared.Rpc.Grpc.Messages.LoginRequest request, grpc::ServerCallContext context)
      {
    ...
    {
      serviceBinder.AddMethod(__Method_Login, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::MyName.Shared.Rpc.Grpc.Messages.LoginRequest, global::MyName.Shared.Rpc.Grpc.Messages.GrpcResponse>(serviceImpl.Login));
    }
