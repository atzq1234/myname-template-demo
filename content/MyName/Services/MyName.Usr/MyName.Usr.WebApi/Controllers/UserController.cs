namespace MyName.Usr.WebApi.Controllers;
...
[Route("usr/users")]
[ApiController]
public class UserController : MyNameControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [MyNameAuthorize(PermissionConsts.User.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [MyNameAuthorize(PermissionConsts.User.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [MyNameAuthorize(PermissionConsts.User.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpPut("{id}/roles")]
    [MyNameAuthorize(PermissionConsts.User.SetRole)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpPut("{id}/status")]
    [MyNameAuthorize(PermissionConsts.User.ChangeStatus)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet()]
    [MyNameAuthorize(PermissionConsts.User.GetList)]
    [ProducesResponseType(StatusCodes.Status200OK)]
