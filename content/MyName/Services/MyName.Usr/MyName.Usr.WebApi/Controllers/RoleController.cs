...
[Route("usr/roles")]
[ApiController]
public class RoleController : MyNameControllerBase
{
    ...
    /// <returns></returns>
    [HttpGet()]
    [MyNameAuthorize(PermissionConsts.Role.GetList)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [MyNameAuthorize(PermissionConsts.Role.Delete)]
    ...
    [MyNameAuthorize(PermissionConsts.Role.SetPermissons)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpPost]
    [MyNameAuthorize(PermissionConsts.Role.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [MyNameAuthorize(PermissionConsts.Role.Update)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
