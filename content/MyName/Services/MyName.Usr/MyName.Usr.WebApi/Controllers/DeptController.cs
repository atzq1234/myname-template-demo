...
[Route("usr/depts")]
[ApiController]
public class DeptController : MyNameControllerBase
{
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [MyNameAuthorize(PermissionConsts.Dept.Delete)]
    ...
    /// <returns></returns>
    [HttpPost]
    [MyNameAuthorize(PermissionConsts.Dept.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [MyNameAuthorize(PermissionConsts.Dept.Update)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet()]
    [MyNameAuthorize(PermissionConsts.Dept.GetList, MyNameAuthorizeAttribute.JwtWithBasicSchemes)]
