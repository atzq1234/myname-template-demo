using MyName.Shared.Application.Contracts;
...
[Route("usr/menus")]
[ApiController]
public class MenuController : MyNameControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [MyNameAuthorize(PermissionConsts.Menu.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [MyNameAuthorize(PermissionConsts.Menu.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [MyNameAuthorize(PermissionConsts.Menu.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet()]
    [MyNameAuthorize(PermissionConsts.Menu.GetList)]
